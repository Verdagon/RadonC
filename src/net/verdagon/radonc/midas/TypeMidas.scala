...
import net.verdagon.radonc.scout.{Mutability, Mutable}

//object TypeMidas {
//  def translateReferences(miduts0: Miduts, contextMutability: Mutability, pointers3: List[Reference3]):
...
//  }
//
//  def translateReference(miduts0: Miduts, contextMutability: Mutability, pointer3: Reference3):
//  (Miduts, Reference4) = {
...
//        val stackMutability = Mutable // All stack frames are mutable
...
//      }
//      case Str3() => throw new RuntimeException("no idea")
//      case sr : StructRef3 => {

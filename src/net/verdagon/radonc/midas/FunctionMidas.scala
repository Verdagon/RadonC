...
//    val stackMutability = Mutable // All stack frames can be mutated
...
//      case head3 :: tail3 => {
//        val (miduts1, lineMap1, nextLine1, head4) =
//          translateNode(miduts0, lineMap0, nextLine0, head3)
//        val (miduts2, lineMap2, nextLine2, tail4) =
//          translateNodes(miduts1, lineMap1, nextLine1, tail3)
...
//        val lineMap1 = lineMap0.updated(line3, nextLine0)
//        (miduts0, lineMap1, nextLine0 + 1, List(node4))
//      }
//      case Argument3(line3, resultType3, argumentIndex) => {
//        val (miduts1, resultType4) = TypeMidas.translateReference(miduts0, contextMutability = Mutable, resultType3)
//        val node4 = Argument4(nextLine0, argumentIndex, resultType4)
//        val lineMap1 = lineMap0.updated(line3, nextLine0)
//        (miduts1, lineMap1, nextLine0 + 1, List(node4))
//      }
...
//        val (miduts1, paramTypes4) = TypeMidas.translateReferences(miduts0, contextMutability = Mutable, paramTypes3)
//        val (miduts2, resultType4) = TypeMidas.translateReference(miduts1, contextMutability = Mutable, resultType3)
//        val node4 = Call4(nextLine0, functionLine, argLines.map(lineMap0), paramTypes4, resultType4)
//        val lineMap1 = lineMap0.updated(line3, nextLine0)
//        (miduts2, lineMap1, nextLine0 + 1, List(node4))
//      }
...
//              throw new RuntimeException("Closure struct lookups expect a variable address field!")
//            }
//            case VariableAddressStructFieldType4(reference4) => reference4
//          }
//        assert(memberType4 == resultType4)
//
...
//        val stackMutability = Mutable // Stacks can always be mutated

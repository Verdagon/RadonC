...
case class Free4(registerId: Int, sourceRegisterId: Int) extends Node4 {
  override def register: Register4 = throw new RuntimeException("this has no result type")
}
...
case class Panic4(registerId: Int) extends Node4 {
  override def register = throw new RuntimeException("this has no result type")
}

...
//  }
//
//  def translateStructMembers(miduts0: Miduts, structMutability: Mutability, members: List[StructMember3]):
...
//          })
//
//        val eTable4 = throw new RuntimeException("not yet")
//        val edges4 = throw new RuntimeException("not yet")
//
//        val structDef4 =
//          StructDefinition4(
...
//      miduts0: Miduts, contextMutability: Mutability, pointer3: Reference3):
...
//
//    if (contextMutability == Immutable && ownership == Own) {
//      assert(false); // Immutable objects cannot own mutables
//    }
//    if (contextMutability == Immutable && moved) {
//      assert(false); // Can't move out from an immutable object
//    }
//    if (ownership == Own && mutability == Immutable) {
//      assert(false); // Can't own an immutable
//    }
//
...
//
//    val isInline =
//      if (mutability == Immutable && small) {
//        true
//      } else if (mutability == Mutable && ownership == Own && !moved) {
//        true
//      } else {
//        false
//      };

...
//  }
  ...
  def getReferenceLlvmType(reference: Reference3): String = {
...
//    if (tyype.isInstanceOf[Reference2]) {
//      getFullName(tyype.asInstanceOf[Reference2])
...
//  }
  ...
  private def getIdentifierName(tyype: CoercedTemplateArg2): String = {
